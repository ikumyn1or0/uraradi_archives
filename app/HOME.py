...
md_text3 = """
2023年3月3日現在、#01-#72の書き起こしに対応しています。（2023年3月3日追記：使用しているpythonパッケージの更新に伴いコードの修正を実施中なので、最新の書き起こしデータが対応できていない場合があります。放送時間可視化機能は最新回まで対応予定です。）

本サイトにおいて「ラジオが放送される日付」とは金曜日のことを指します。
